        ...
        <div className="row">
            <div className="col-sm-2 col-md-7 col-lg-10 mx-auto">
                ...
                <div className="card-body p-4 p-sm-1">
                    ...
                    <div className="form-floating mb-1">
                        <input type="emailOTP" name = 'emailOTP' className="form-control" id="floatingInput" placeholder="Verify Email OTP" onChange = {onChange}></input>
                        <label htmlFor="floatingInput">Verify OTP sent on Email</label>
                    </div>
                    <div className="form-floating mb-1">
                        <input type="phoneNumber" name = 'phoneNumber' className="form-control" id="floatingInput" placeholder="Phone Number" onChange = {onChange}></input>
                        <label htmlFor="floatingInput">Phone Number</label>
                        <Button style = {{marginTop: "3px"}} onClick = {sendPhoneOTP}>SEND OTP</Button>
                    </div>
                    <div className="form-floating mb-1">
                        <input type="phoneOTP" name = 'phoneOTP' className="form-control" id="floatingInput" placeholder="Verify Phone OTP" onChange = {onChange}></input>
